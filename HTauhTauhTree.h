...
HTauhTauhTree::HTauhTauhTree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   ...
   std::string fileName = "WAWHadr_"+filePath.substr(location,filePath.size());   
...
Int_t HTauhTauhTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HTauhTauhTree::LoadTree(Long64_t entry)
{
...
void HTauhTauhTree::Init(TTree *tree)
{
...
void HTauhTauhTree::Show(Long64_t entry)
{
